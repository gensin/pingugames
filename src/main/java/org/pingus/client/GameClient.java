...
public class GameClient {
	...
	public GameStatus joinGame(String playerId, String roomId) {
		...
		GameStatus gameStatus = restTemplate.getForObject(url.toString(),
				GameStatus.class);
		return gameStatus;
	}
	...
	public RoomInformation getRoomStatus(String roomId) {
		...
		RoomInformation info = restTemplate.getForObject(url.toString(),
	...
	public ArrayList<RoomInformation> getRoomStatuses() {
		...
		ArrayList<RoomInformation> info = (ArrayList<RoomInformation>) restTemplate
				.getForObject(url.toString(), ArrayList.class);
		return info;
